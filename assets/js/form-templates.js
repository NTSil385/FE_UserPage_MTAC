...
export const formTemplates = {
  ctnh: {
    ...
    weightFields: {
      ...
      fields: [
        "waste_details.normal",
        "waste_details.light_bulb",
        "waste_details.ma13",
        "waste_details.ma14",
      ],
    },
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            type: "number",
            name: "total_weight",
            label: "Tổng khối lượng chất thải xử lý",
            required: true,
            unit: "kg",
            min: 0,
          },
          {
            type: "number",
            name: "waste_details.normal",
            label: "Khối lượng chất thải thông thường",
            required: true,
            unit: "kg",
            min: 0,
          },
          {
            type: "number",
            name: "waste_details.light_bulb",
            label: "Khối lượng bóng đèn",
            required: true,
            unit: "kg",
            min: 0,
          },
          {
            type: "number",
            name: "waste_details.ma13",
            label: "Khối lượng mã 13",
            required: true,
            unit: "kg",
            min: 0,
          },
          {
            type: "number",
            name: "waste_details.ma14",
            label: "Khối lượng mã 14",
            required: true,
            unit: "kg",
            min: 0,
          },
        ...
        fields: [
          ...
          { type: "text", name: "email", label: "Email", required: true },
          {
            ...
            options: [
              ...
              {
                value: "hcm_kcx",
                label: "TP HCM: KCX Linh Trung 1,2 KCX Tân Thuận",
              },
            ],
          },
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            type: "number",
            name: "shoe_leather_weight",
            label: "Khối lượng chất thải",
            required: true,
            unit: "kg",
            min: 0,
          },
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            type: "number",
            name: "bulky_waste",
            label: "Khối lượng chất thải cồng kềnh",
            required: true,
            unit: "kg",
            min: 0,
          },
        ...
        fields: [
          {
            ...
            required: true,
            options: [{ value: "hcm", label: "TP Hồ Chí Minh" }],
          },
          {
            type: "select",
            ...
            options: [
              ...
              {
                value: "phong_tai_nguyen",
                label: "Phòng Tài nguyên và Môi trường",
              },
            ],
          },
        ],
