...
function updateClock() {
  ...
  digitalClock.textContent = now.toLocaleTimeString("vi-VN", {
    hour: "2-digit",
    minute: "2-digit",
    second: "2-digit",
  });
  ...
  try {
    ...
    switch (iconCode.substr(0, 2)) {
      ...
      case "10":
        ...
        break;
      case "11":
        weatherIcon.classList.add("bx-cloud-lightning");
        break;
      case "13":
        weatherIcon.classList.add("bx-cloud-snow");
        break;
      case "50":
        weatherIcon.classList.add("bx-water");
        break;
      default:
        weatherIcon.classList.add("bx-cloud");
    }
