...
export const transformFunctions = {
    ...
    authority: (value) => {
        ...
        return authorities[value] || value;
    },
    
    location: (value) => {
        // Kiểm tra trong cả hai loại dữ liệu location
        const wasteLocation = wasteLocationData[value];
        const envDocLocation = envDocLocationData[value];
        
        // Trả về tên location phù hợp
        return wasteLocation || envDocLocation || value;
    },

    province: (value) => {
        console.log('Province transform input:', value); // Debug log
        
        // Object map ngược từ tên hiển thị sang key
        const reverseLocations = {
            'TP Hồ Chí Minh': 'hcm',
            'TPHCM (Các quận nội thành)': 'hcm',
            'TP HCM: KCX Linh Trung 1,2 KCX Tân Thuận': 'hcm_kcx',
            'TPHCM - Cần giờ': 'hcm_cg',
            'Long An - Mộc Hóa, Kiến Tường': 'longan_mkkt',
            'Long An - còn lại': 'longan_other',
            'Đồng Nai - Biên Hòa': 'dongnai_bh',
            'Đồng Nai - Trảng Bom, Long Thành, Nhơn Trạch': 'dongnai_tbltn',
            'Đồng Nai - Còn lại': 'dongnai_other',
            'Bình Dương - Thuận An, Dĩ An, Thủ Dầu Một': 'binhduong_main',
            'Bình Dương - còn lại': 'binhduong_other',
            'Sở TNMT': 'so_tnmt',
            'Hepza': 'hepza',
            'Long An': 'long_an',
            'Tây Ninh': 'tay_ninh',
            ...
            'Bến Tre': 'ben_tre',
            'Huế/Đà Nẵng/Quảng Nam': 'hue_da_nang_quang_nam'
        };

        const result = reverseLocations[value] || value;
        console.log('Province transform output:', result); // Debug log
...
export const formTemplates = {
    ...
    'dtm': {
        title: 'Báo cáo đánh giá tác động môi trường sơ bộ (ĐTM sơ bộ)',
        sections: [
            {
                title: 'Thông tin liên hệ',
                fields: [
                ...
                fields: [
                    {
                        ...
                        required: true,
                        options: convertLocationDataToArray(authorityData)
                    },
                    {
                        type: 'select',
                        name: 'province',
        ...
        sections: [
            {
                ...
                fields: [
                    { type: 'text', name: 'contact_name', label: 'Người liên hệ', required: true },
                    { type: 'text', name: 'phone', label: 'S��� điện thoại', required: true },
                    { type: 'text', name: 'email', label: 'Email', required: true },
                    { type: 'text', name: 'company_name', label: 'Tên doanh nghiệp', required: true },
        ...
        sections: [
            {
                title: 'Thông tin dự án',
                fields: [
                    { name: 'province', label: 'Khu vực thực hiện', transform: 'province' },
        ...
        sections: [
            {
                ...
                fields: [
                    ...
                    { name: 'phone', label: 'Số điện thoại' },
                    { name: 'email', label: 'Email' },
                    { name: 'company_name', label: 'Tên doanh nghiệp' }
                ]
            },
            {
                title: 'Thông tin báo cáo',
